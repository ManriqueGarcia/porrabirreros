/**
 * Admin roles: { general: bool, f1: bool, futbol: bool }
...
export function getAdminRoles(user) {
  if (!user) return { general: false, f1: false, futbol: false };
  if (user.isAdmin && !user.adminRoles) return { general: true, f1: true, futbol: true };
  return {
