...
- **Archivos duplicados**: `src/scoring.js` (frontend build) y `lib/scoring.mjs` (tests Vitest) contienen la misma logica de puntuacion. **Siempre actualizar ambos** al modificar scoring
